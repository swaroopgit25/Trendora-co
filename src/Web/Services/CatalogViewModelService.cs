...
public class CatalogViewModelService : ICatalogViewModelService
{
    ...
    public async Task<CatalogIndexViewModel> GetCatalogItems(int pageIndex, int itemsPage, int? brandId, int? typeId, string? searchTerm = null)
    {
        _logger.LogInformation("GetCatalogItems called.");

        var filterSpecification = new CatalogFilterSpecification(brandId, typeId, searchTerm);
        var filterPaginatedSpecification =
            new CatalogFilterPaginatedSpecification(itemsPage * pageIndex, itemsPage, brandId, typeId, searchTerm);
        ...
        var vm = new CatalogIndexViewModel()
        {
            CatalogItems = itemsOnPage.Select(i => new CatalogItemViewModel()
            {
                ...
                Price = i.Price,
                Options = i.Options.Select(o => new ProductOptionViewModel
                {
                    Id = o.Id,
