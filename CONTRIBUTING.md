# Contributing to NimblePros/Fiamma
...
Look for [issues marked with 'help wanted'](https://github.com/NimblePros/Fiamma/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) to find good places to start contributing.
...
## Report bugs using Github's [issues](https://github.com/NimblePros/Fiamma/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/NimblePros/Fiamma/issues/new/choose); it's that easy!
