...
To deploy the Fiamma sample to a Windows 2016 virtual machine running Docker on Azure, from Visual Studio, follow these step-by-step instructions:
...
1. Direct your web browser to http://your_ip_address_of_your_virtual_machine. You should see an instance of the Fiamma site running
