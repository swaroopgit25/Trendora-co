...
We have the ability to manage users in the Fiamma admin portal. However, users themselves can manage their passwords and external logins. The User Management section was built with some administrative flags in mind - confirming emails, confirming phone numbers, and the ability to disable MFA if needed.
...
- The product manager can add, edit, and delete products in the Fiamma admin portal.
- The administrator can manage users and roles in the Fiamma admin portal.
...
![Fiamma User Management, showing sadukie-admin logged in. sadukie-admin cannot edit their user entry nor the admin@microsoft.com user entry.](../assets/images/features/Fiamma-user-management-no-admin-delete.png)
