...
Fiamma has a storefront and an admin portal. As like any other storefront, we don't want our users to be able to manage the products. We also don't want our system admins managing products. We have product managers to manage the products.
...
![Role Management in Fiamma's admin portal](../assets/images/features/Fiamma-manage-roles-manage-members-button.png)

## Starting Roles

The starting roles in Fiamma include:
