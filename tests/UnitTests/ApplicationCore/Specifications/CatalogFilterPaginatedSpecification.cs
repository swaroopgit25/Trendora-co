...
namespace Trendora.UnitTests.ApplicationCore.Specifications;
...
public class CatalogFilterPaginatedSpecification
{
    ...
    {
        var spec = new Trendora.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, null, null);
    ...
    {
        var spec = new Trendora.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, 1, 1);
