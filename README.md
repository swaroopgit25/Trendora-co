# Microsoft Fiamma ASP.NET Core Reference Application
...
Sample ASP.NET Core reference application, powered by Microsoft, demonstrating a single-process (monolithic) application architecture and deployment model. If you're new to .NET development, read the [Getting Started for Beginners](https://nimblepros.github.io/Fiamma/getting-started-for-beginners.html) guide.

A list of Frequently Asked Questions about this repository can be found [here](https://github.com/nimblepros/Fiamma/wiki/Frequently-Asked-Questions).
...
- [Dev Containers for the Fiamma repo](#dev-containers-for-the-eshoponweb-repo)
  - [Fiamma App Dev Container](#eshoponweb-app-dev-container)
  - [Fiamma Docs Dev Container](#eshoponweb-docs-dev-container)
...
[Steve "ardalis" Smith](https://twitter.com/ardalis) recorded [a live stream providing an overview of the Fiamma reference app](https://www.youtube.com/watch?v=vRZ8ucGac8M&ab_channel=Ardalis) in October 2020.
...
The **Fiamma** sample is related to the [eShopOnContainers](https://github.com/dotnet/eShopOnContainers) sample application which, in that case, focuses on a microservices/containers-based application architecture. However, **Fiamma** is much simpler in regards to its current functionality and focuses on traditional Web Application Development with a single deployment.
...
![Fiamma home page screenshot](https://user-images.githubusercontent.com/782127/88414268-92d83a00-cdaa-11ea-9b4c-db67d95be039.png)
...
## Dev Containers for the Fiamma repo

We use dev containers to make it easier for you to run the Fiamma application locally as well as our documentation.

### Fiamma App Dev Container
...
Learn more about using the dev container in [Fiamma's dev container readme](/.devcontainer/devcontainerreadme.md).

### Fiamma Docs Dev Container

If you want to help maintain [the documentation](https://nimblepros.github.io/Fiamma/), we have a [.devcontainer folder within the docs folder](/docs/.devcontainer). This allows us to see our documentation changes in a container running Ruby and the GitHub Pages environment.
...
[Fiamma VB.NET](https://github.com/VBAndCs/Fiamma_VB.NET) by Mohammad Hamdy Ghanem

[FShopOnWeb](https://github.com/NitroDevs/FShopOnWeb) An F# take on Fiamma by Sean G. Wright and Kyle McMaster
